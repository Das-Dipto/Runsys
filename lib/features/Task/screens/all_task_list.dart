    ...
    if (_tasks.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.assignment_outlined, size: 62, color: _textSec),
            const SizedBox(height: 20),
            const Text(
              'No tasks assigned.',
              style: TextStyle(fontSize: 18, color: _textSec),
            ),
          ],
        ),
      );
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Icons.person_outline_rounded, size: 11, color: Color(0xFF8A8A9A)),
                const SizedBox(width: 6),
                Text(
