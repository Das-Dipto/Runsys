...
class WeekTaskList extends StatefulWidget {
  const WeekTaskList({super.key});

  @override
  State<WeekTaskList> createState() => _WeekTaskListState();
}

class _WeekTaskListState extends State<WeekTaskList> {
  ...
  Future<void> _loadTasks() async {
    ...
    if (result['success'] == true) {
      ...
      int daysToSat = (today.weekday % 7 == 6) ? 0 : today.weekday + 1;
      final weekStart = today.subtract(Duration(days: daysToSat));
